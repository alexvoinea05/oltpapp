...
import ro.oltpapp.service.mapper.CompanyMapper;
...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().name(DEFAULT_NAME).identificationNumber(DEFAULT_IDENTIFICATION_NUMBER);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().name(UPDATED_NAME).identificationNumber(UPDATED_IDENTIFICATION_NUMBER);
        return company;
    }
    ...
    void createCompany() throws Exception {
        ...
        assertThat(testCompany.getIdentificationNumber()).isEqualTo(DEFAULT_IDENTIFICATION_NUMBER);
    }
    ...
    void checkIdentificationNumberIsRequired() throws Exception {
        int databaseSizeBeforeTest = companyRepository.findAll().size();
        // set the field null
        company.setIdentificationNumber(null);
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.name(UPDATED_NAME).identificationNumber(UPDATED_IDENTIFICATION_NUMBER);
        ...
        assertThat(testCompany.getIdentificationNumber()).isEqualTo(UPDATED_IDENTIFICATION_NUMBER);
    }
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.identificationNumber(UPDATED_IDENTIFICATION_NUMBER);
    ...
    void fullUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.name(UPDATED_NAME).identificationNumber(UPDATED_IDENTIFICATION_NUMBER);
