...
import ro.oltpapp.repository.AddressRepository;
import ro.oltpapp.service.dto.AddressDTO;
import ro.oltpapp.service.mapper.AddressMapper;
...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().streetNumber(DEFAULT_STREET_NUMBER).street(DEFAULT_STREET).zipcode(DEFAULT_ZIPCODE);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().streetNumber(UPDATED_STREET_NUMBER).street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
        return address;
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.streetNumber(UPDATED_STREET_NUMBER).street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.streetNumber(UPDATED_STREET_NUMBER).street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
