...
describe('Train Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'train', component: TrainComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.trains?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
