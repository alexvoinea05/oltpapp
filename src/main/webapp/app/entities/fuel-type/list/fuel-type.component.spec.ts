...
describe('FuelType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'fuel-type', component: FuelTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fuelTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fuelTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFuelTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFuelTypeIdentifier).toHaveBeenCalledWith(entity);
