...
export type PartialUpdateAppUser = Partial<IAppUser> & Pick<IAppUser, 'idUser'>;
...
export class AppUserService {
  ...
  getAppUserIdentifier(appUser: Pick<IAppUser, 'idUser'>): number {
    return appUser.idUser;
  }

  compareAppUser(o1: Pick<IAppUser, 'idUser'> | null, o2: Pick<IAppUser, 'idUser'> | null): boolean {
    return o1 && o2 ? this.getAppUserIdentifier(o1) === this.getAppUserIdentifier(o2) : o1 === o2;
  }

  addAppUserToCollectionIfMissing<Type extends Pick<IAppUser, 'idUser'>>(
