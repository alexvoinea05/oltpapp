...
describe('AppUser Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      const appUser: IAppUser = { idUser: 456 };
    ...
    it('Should call UserType query and add missing value', () => {
      const appUser: IAppUser = { idUser: 456 };
      const idUserType: IUserType = { id: 79485 };
      appUser.idUserType = idUserType;

      const userTypeCollection: IUserType[] = [{ id: 9127 }];
      jest.spyOn(userTypeService, 'query').mockReturnValue(of(new HttpResponse({ body: userTypeCollection })));
      const additionalUserTypes = [idUserType];
    ...
    it('Should update editForm', () => {
      ...
      appUser.user = user;
      const idUserType: IUserType = { id: 40699 };
      appUser.idUserType = idUserType;
      ...
      expect(comp.userTypesSharedCollection).toContain(idUserType);
  ...
  describe('save', () => {
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<IAppUser>>();
      const appUser = { idUser: 123 };
      jest.spyOn(appUserFormService, 'getAppUser').mockReturnValue({ idUser: null });
